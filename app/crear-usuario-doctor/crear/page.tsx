...
const Page = () => {
  ...
  return (
    <div className={`app`}>
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-12">
              <ul className="tipo-de-citas d-flex flex-nowrap overflow-auto justify-content-xl-center justify-content-lg-center justify-content-md-center justify-content-sm-center justify-content-start mb-5">
                <li className={`activo ${poppinsMenu.className}`}>
                  <Link href={"crear"}>Crear Usuario</Link>
                </li>
                <li className={`${poppinsMenu.className}`}>
                  <Link href={"mantenimiento"}>Mantenimiento de usuarios</Link>
                </li>
              </ul>
            </div>
            <div className="col-12">
              <div className={`${robotoMenu.className} sb-titulos-negro mb-3`}>
                Tipo de usuario
              </div>
            </div>
            <div
              className="col-12 d-flex align-items-center justify-content-center mb-3"
              style={{ gap: "16px" }}
            >
              <label
                ...
                <div className="row">
                    ...
                    <div className="form-box mb-4">
                      ...
                      <div className="input-grupo mb-3">
                        <input
                          ...
                          type="text"
                          name=""
                          placeholder="Ingresa su doc. de identidad"
                          id=""
                        />
                      </div>
                    </div>
                  ...
                  <div className="col-12">
                    <div className="form-box mb-4">
                      ...
                      >
                        {parse(svgPassword)}{" "}
                        <span className="ms-1">Contraseña</span>
                      </label>
                      <div className="input-grupo mb-3">
                        <input
                          className=""
                          type="password"
                          name=""
                          placeholder="Ingresa la contraseña de apertura"
                          id=""
                        />
                      </div>
                    </div>
                  ...
                  <div className="col-12">
                    <button
                      ...
                      className={`text-white fw-bold login2 rounded-5 border-0 d-block mx-auto mb-3 ${robotoMenu.className}`}
                    >
                      Registrar
                    </button>
                  </div>
      ...
      <div className="taskbar_capa d-flex flex-align-content-center align-content-between justify-content-center taskbar-altura  taskbar-altura">
          ...
          <div className="container-fluid">
            <div className="row">
              <div className="col-12 d-flex flex-column">
                <div className="txtinfo txt-center mx-auto mb-4 ok">
                  ¡Usuario registrado!
                </div>
                <svg
                ...
                >
                  ...
                  />
                  <path
                    d="M44.8317 40.9969C44.612 40.9749 44.3483 40.9749 44.1066 40.9969C38.8773 40.8211 34.7246 36.5366 34.7246 31.2633C34.7246 25.8802 39.0751 21.5078 44.4801 21.5078C49.8633 21.5078 54.2357 25.8802 54.2357 31.2633C54.2137 36.5366 50.061 40.8211 44.8317 40.9969Z"
                    stroke="#F2F4F8"
                    stroke-width="3.5"
                  ...
                  />
                  <path
                    d="M33.8457 49.1048C28.5285 52.6642 28.5285 58.4648 33.8457 62.0023C39.888 66.0451 49.7973 66.0451 55.8396 62.0023C61.1568 58.4428 61.1568 52.6422 55.8396 49.1048C49.8193 45.0839 39.9099 45.0839 33.8457 49.1048Z"
                    stroke="#F2F4F8"
                    stroke-width="3.5"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
                  <circle cx="71.5" cy="80.5" r="19.5" fill="#BBE550" />
                  <circle cx="72" cy="81" r="15" fill="#A4D42B" />
                  <circle cx="72" cy="81" r="11" fill="#BBE550" />
                  <path
                    d="M70.5649 83.1105L67.748 81.2515C67.1549 80.8601 66.3667 80.9501 65.8772 81.4651C65.2821 82.0911 65.3541 83.0931 66.0324 83.6276L71.1846 87.6871L76.9805 77.3708C77.4518 76.5319 77.1148 75.4692 76.2461 75.0552C75.4171 74.66 74.4247 75.0118 74.0295 75.8409L70.5649 83.1105Z"
                    fill="#F2F4F8"
                  />
                </svg>
